...
The default resource set contains management groups, associations, resource groups, Azure policy, managed identities for assignments, ordinary static Entra security groups, Azure RBAC, virtual networks, and NSGs. It does not turn on paid Defender plans or automate deployment/remediation of chargeable resources. No deployment-script container/storage or premium group feature is provisioned for group creation.
