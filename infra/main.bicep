...
module application './application.bicep' = {
  ...
  params: {
    ...
    tags: tags
    applicationTeamGroupObjectId: applicationTeamGroupObjectId
  }
  dependsOn: [placement]
}
...
module platformRbac './modules/group-role.bicep' = if (!empty(platformAdminsGroupObjectId)) {
...
output scaffoldNotice string = 'No paid runtime services, peering, egress, central logging, Entra configuration, or automatic policy remediation are provisioned. See docs/operations.md before deploying workloads.'
